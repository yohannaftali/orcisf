...
| #72 | fix(src): loads disappear from Loads panel after a completed optimization run | ready-for-review (tester: PASS -- both pre-run AND post-run states now confirmed live, unblocked now that #63 is fixed: Loads panel showed batang 5-8 at 35000 N/m before Run, and identically 35000 N/m after a completed run showing "100%/Run complete.", screenshots for both) | 2026-08-17 |
